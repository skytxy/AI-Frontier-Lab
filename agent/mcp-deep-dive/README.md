...
| 实验 | 主题 | 关键收获 | 难度 | 前置 |
|------|------|----------|------|------|
| [Exp-01](/agent/mcp-deep-dive/experiments/01-protocol-inspector/) | 协议拦截器 | 亲眼看见 JSON-RPC 消息流，理解分帧 | ★★☆ | 无 |
| [Exp-02](/agent/mcp-deep-dive/experiments/02-mcp-server/) | 从零实现 Server | 掌握 Tools/Resources/Prompts 三大原语 | ★★★ | Exp-01 |
| [Exp-03](/agent/mcp-deep-dive/experiments/03-mcp-client/) | 手写 Client（无 SDK） | 深入协议本质：编解码、分帧、配对 | ★★★★ | Exp-01, Exp-02 |
| [Exp-04](/agent/mcp-deep-dive/experiments/04-security-lab/) | 安全攻防 | 理解 annotation 欺骗与 prompt injection | ★★★★ | Exp-01, Exp-02 |

> **零基础？** 先阅读 [MCP 入门指南](/agent/mcp-deep-dive/concepts/mcp-basics)，以及其他前置知识：
...
> - [安全模型](/agent/mcp-deep-dive/concepts/security-model)
...
→ [进入实验](/agent/mcp-deep-dive/experiments/01-protocol-inspector/)
...
→ [进入实验](/agent/mcp-deep-dive/experiments/02-mcp-server/)
...
→ [进入实验](/agent/mcp-deep-dive/experiments/03-mcp-client/)
...
→ [进入实验](/agent/mcp-deep-dive/experiments/04-security-lab/)
...
1. 跳读 [concepts](/agent/mcp-deep-dive/concepts/mcp-basics) 文档，查漏补缺
2. 直接从 [Exp-02](/agent/mcp-deep-dive/experiments/02-mcp-server/) 开始
3. 需要调试时回到 [Exp-01](/agent/mcp-deep-dive/experiments/01-protocol-inspector/)

### 路径 B：系统学习（零基础）

如果你是第一次接触 MCP：
1. 阅读 [concepts/mcp-basics](/agent/mcp-deep-dive/concepts/mcp-basics)
2. 完成 [Exp-01](/agent/mcp-deep-dive/experiments/01-protocol-inspector/)（理解消息流）
3. 完成 [Exp-02](/agent/mcp-deep-dive/experiments/02-mcp-server/)（实现 Server）
4. 完成 [Exp-03](/agent/mcp-deep-dive/experiments/03-mcp-client/)（手写 Client）
5. 完成 [Exp-04](/agent/mcp-deep-dive/experiments/04-security-lab/)（安全攻防）

### 路径 C：安全研究（重点关注）

如果你关心 MCP 安全：
1. 快速浏览 [Exp-01](/agent/mcp-deep-dive/experiments/01-protocol-inspector/) 和 [Exp-02](/agent/mcp-deep-dive/experiments/02-mcp-server/)
2. 深入 [Exp-04](/agent/mcp-deep-dive/experiments/04-security-lab/)
3. 阅读 [concepts/security-model](/agent/mcp-deep-dive/concepts/security-model)
